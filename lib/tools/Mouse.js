...
Mouse.prototype.selected = function (animation) {
    ...
    var exist = Globals.paramNotExist(animation, "object");
        ...
        this.group.forEach((tile) => {
            ...
            if (tile.type === "tile") {
                ...
                if (inside) {
                    ...
                    tile.tint = exist ? 0x98FB98 : animation.tint || 0x98FB98 ;
                    tile.alpha = exist ? 1.3 + Math.sin(this.game.time.now * 0.007) : animation.alpha || 1.3 + Math.sin(this.game.time.now * 0.007);
