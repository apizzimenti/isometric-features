...
Debug.prototype.sprite = function (sprites) {
    ...
    if (this.on) {
        var debugSprite = (sprite) => {
            this.game.debug.text(`${sprite.row}, ${sprite.col}`, this.x, this.y, this.color);
            this.game.debug.body(sprite.tile.top, "#FF0000", false);
            this.game.debug.body(sprite, "#FFFFFF", false);
