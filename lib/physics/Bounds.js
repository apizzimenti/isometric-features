 ...
 *
 * @param {object} context  The context in which a sprite object exists.
 *
 * @returns {object}        Each property specifies if the immediate top, left, bottom, right,
 *                          or none of the previous tiles are blocked.
 *
 * @see Animal
 * @see Player
 */
 ...
 *
 * @param {object} Mouse    Mouse object to check.
 *
 ...
 *
 * @param {number} tileSize     Size of an individual tile.
 * @param {number} mapSize      Desired size of the map. The map will be an array of mapSize * mapSize.
 * @param {number} num          Number used to move world boundaries back num rows.
 *
 * @returns {number} Number of pixels in plane.
 *
 * @see Map
 */
