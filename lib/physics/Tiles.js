 ...
 *
 * @param {Animal | Player | Item} Sprite   Object containing a Phaser isometric sprite.
 *
 * @returns {undefined}
 *
 * @see Animal
 ...
 *
 * @param {number} length   Length of containing array.
 * @param {number} dim      Row or column number.
 *
 ...
 *
 * @param {Player | Animal} sprite  Sprite's parent.
 ...
 *
 * @param {object[]} path   Array of coordinate objects.
 *
 ...
 *
 * @param {Animal | Player} sprite  The sprite to be reset.
 * @param {boolean} body            Will the sprite's body move?
 *
 * @returns {undefined}
 */
